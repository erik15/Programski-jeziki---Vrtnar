package edu.erik.naloga2_1.data;


import edu.erik.naloga2_1.android.Rezultati;
...
public class DBAdapterRezultat implements BaseColumns {
	...
	//---insert a stevec
	public long insertStevc(Rezultati stevec) 
	{
	...
	//---update---
	public boolean updateStevec(Rezultati tmp) 
	{
